    ...
    public class WarrantyInfoService : IWarrantyInfoService
    {
        ...
        public async Task<ApiResponse<IEnumerable<WarrantyInfoDto>>> GetExpiringWarrantiesAsync(int days)
        {
            try
            {
                ...
                if (warranties == null)
                {
                    return ApiResponse<IEnumerable<WarrantyInfoDto>>.SuccessResponse(
                        new List<WarrantyInfoDto>(), 
            ...
            {
                // Get the innermost exception for better error reporting
                ...
                return ApiResponse<IEnumerable<WarrantyInfoDto>>.ErrorResponse(
                    ...
                    new List<string> { ex.Message, innerException.Message });
            }
        }
